                    ...
                    <div className="col-lg-6">
                        <div className="contloca">
                            ...
                            <div data-gsap>
                                ...
                                <h3><a href="#!">A-105, Greenscape Technocity, Mahape, Navi Mumbai - 400701</a></h3>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="timingbox">
                            ...
                            <div className='social1' >
                                ...
                                <ul>
                                    ...
                                    <li data-gsap><a href="#!"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <li data-gsap><a href="#!"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <path d="M22 4.00002C22 4.00002 21.3 6.10002 20 7.40002C21.6 17.4 10.6 24.7 2 19C4.2 19.1 6.4 18.4 8 17C3 15.5 0.5 9.60002 3 5.00002C5.2 7.60002 8.6 9.10002 12 9.00002C11.1 4.80002 16 2.40002 19 5.20002C20.1 5.20002 22 4.00002 22 4.00002Z" stroke="#B1EBE0" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg></a></li>
                                </ul>
